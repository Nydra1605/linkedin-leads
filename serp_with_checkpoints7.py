...
def save_to_csv(data: dict, company_name: str, filename: str = "job7_output.csv"):
...
def process_companies_from_csv(input_csv_file: str, output_csv_file: str = "job7_output.csv"):
    """
...
if __name__ == "__main__":
    ...
    INPUT_CSV_FILE = "job7.csv"  # Change this to your actual file path
    OUTPUT_CSV_FILE = "job7_output.csv"  # Output file name
